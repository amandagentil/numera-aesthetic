...
simple_theme <- function(font) {
  
        p <- theme_grey() +
            theme(panel.grid = element_blank(),
                  panel.background = element_rect(fill = "white"),
                  title = element_text(family = "font", colour = "#4D4D4D"),
                  axis.text = element_text(family = "font", colour = "#4D4D4D", size = 8),
                  axis.text.x = element_text(vjust = 2),
                  legend.text = element_text(family = "font", colour = "#4D4D4D"),
                  ...
                  strip.text = element_text(family = "font", colour = "#474747", size = 9),
